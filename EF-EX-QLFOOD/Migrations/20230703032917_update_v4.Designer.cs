...
namespace EF_EX_QLFOOD.Migrations
{
    ...
    [Migration("20230703032917_update_v4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CongThucNguyenLieu", b =>
                {
                    b.Property<int>("CongThucID")
                        .HasColumnType("int");

                    b.Property<int>("NguyenLieusNguyenLieuID")
                        .HasColumnType("int");

                    b.HasKey("CongThucID", "NguyenLieusNguyenLieuID");

                    b.HasIndex("NguyenLieusNguyenLieuID");

                    b.ToTable("CongThucNguyenLieu");
                });
            ...
            modelBuilder.Entity("CongThucNguyenLieu", b =>
                {
                    b.HasOne("EF_EX_QLFOOD.Entities.CongThuc", null)
                        .WithMany()
                        .HasForeignKey("CongThucID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EF_EX_QLFOOD.Entities.NguyenLieu", null)
                        .WithMany()
                        .HasForeignKey("NguyenLieusNguyenLieuID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EF_EX_QLFOOD.Entities.CongThuc", b =>
                {
                    b.HasOne("EF_EX_QLFOOD.Entities.MonAn", "MonAn")
                        .WithOne("CongThuc")
                        .HasForeignKey("EF_EX_QLFOOD.Entities.CongThuc", "MonAnID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
